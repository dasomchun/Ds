...
public class StringEx7 {
    public static void main(String[] args) {
        ...
        System.out.println(str.indexOf("Hong")); //Hong 문자의 위치
        System.out.println(str.indexOf("H")); //H문자의 위치
        System.out.println(str.substring(17)); //17번 인덱스부터 끝까지 잘라냄
        System.out.println(str.substring(6, 13)); //6번 인덱스부터 13전까지 문자열
        ...
        System.out.println(str.endsWith("Dong")); //dong 으로 끝나는지
        System.out.println(str.replace("Hong", "Kim")); //hong을 kim으로 체인지

        System.out.println(str.replaceAll("Name", "NickName")); //name을 닉네임으로 치환
